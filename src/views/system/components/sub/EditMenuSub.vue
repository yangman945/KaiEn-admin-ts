<template>
  <el-dialog v-model="dialogVisible" title="编辑子菜单" width="600px" destroy-on-close>
    <div>
...
import { editMenuSubRequest } from "@/api/system";
...
const editMenuSub = (data) => {
  editMenuSubRequest(data)
    .then((res) => {
      console.log(res);
